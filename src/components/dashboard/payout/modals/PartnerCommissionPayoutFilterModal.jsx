...
export default function PartnerCommissionPayoutFilterModal({ onClose, onApplyFilter }) {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md">
        <div className="p-4 border-b flex items-center justify-between">
          <h3 className="font-medium text-lg text-teal-500">Filter Partner Payouts</h3>
          <button 
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          ...
          <div>
            <label htmlFor="partnerId" className={styles.labelClass}>Partner ID</label>
            <input
              type="text"
              id="partnerId"
              name="partnerId"
