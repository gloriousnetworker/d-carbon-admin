      ...
      <div className="flex items-stretch gap-3 mb-5">
        ...
        <div className="flex-1 border border-gray-200 rounded-lg px-4 py-3 bg-white">
          <div className="flex items-center justify-between mb-2">
            <span className="font-sfpro text-[10px] text-gray-400 uppercase tracking-wider">Company</span>
            <span className="px-2 py-0.5 rounded-full text-[10px] bg-blue-50 text-blue-700 font-sfpro font-medium">
