...
export default function CommercialPayoutDetails({ payoutDetails, onBack, isLoading }) {
      ...
      <div className="bg-white rounded-lg p-6 max-w-2xl w-full mx-4 max-h-[80vh] overflow-y-auto">
        ...
        <div className="border border-gray-200 rounded-lg p-8 text-center">
          <div className="text-gray-500 mb-4">
            ...
            <p className="text-sm text-gray-400 mt-2">REC_Certificate_COM-001.pdf</p>
          </div>
            ...
            <div className="bg-white rounded-lg p-4 mb-6 border border-[#E5E7EB]">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <span className="font-sfpro text-[14px] text-[#1E1E1E]">• Total RECs generated</span>
                  <span className="font-sfpro text-[14px] font-[600] text-[#1E1E1E]">200.0</span>
                </div>
            
                <div className="flex items-center justify-between">
                  <span className="font-sfpro text-[14px] text-[#1E1E1E]">• Total RECs sold</span>
                  <span className="font-sfpro text-[14px] font-[600] text-[#1E1E1E]">20</span>
                </div>
            
                <div className="flex items-center justify-between">
                  <span className="font-sfpro text-[14px] text-[#1E1E1E]">• Total RECs balance</span>
                  <span className="font-sfpro text-[14px] font-[600] text-[#1E1E1E]">20.0</span>
                </div>
                ...
                <div className="flex items-center justify-between">
                  <span className="font-sfpro text-[14px] text-[#1E1E1E]">• Revenue Tier</span>
