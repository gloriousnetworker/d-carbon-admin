...
export default function UtilityProviderManagement({ onViewChange }) {
  ...
  useEffect(() => {
    const fetchUtilityProviders = async () => {
      ...
      try {
        ...
        const response = await fetch("https://api.dev.dcarbon.solutions/api/admin/utility-providers", {
          method: "GET",
          headers: {
            "Authorization": `Bearer ${authToken}`,
            "Content-Type": "application/json"
  ...
  const handleCreateProvider = async (formData) => {
    try {
      ...
      const result = await response.json();
      if (result.status === "success") {
        const fetchResponse = await fetch("https://api.dev.dcarbon.solutions/api/admin/utility-providers", {
          method: "GET",
          headers: {
            "Authorization": `Bearer ${authToken}`,
            "Content-Type": "application/json"
