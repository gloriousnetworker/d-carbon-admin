...
const ContractTermsTab = () => {
  ...
  const fetchContractTerms = async () => {
    try {
      ...
      const response = await fetch("https://api.dev.dcarbon.solutions/api/commission-contract-terms", {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const authToken = localStorage.getItem("authToken");
      const response = await fetch(`https://api.dev.dcarbon.solutions/api/commission-contract-terms/${id}`, {
        method: "DELETE",
        headers: { Authorization: `Bearer ${authToken}` },
      });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingTerm) {
        response = await fetch(`https://api.dev.dcarbon.solutions/api/commission-contract-terms/${editingTerm.id}`, {
          method: "PATCH",
          headers: {
        ...
        response = await fetch("https://api.dev.dcarbon.solutions/api/commission-contract-terms", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${authToken}`,
