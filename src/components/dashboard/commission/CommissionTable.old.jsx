 ...
 * ./CommissionTable.jsx, which groups rows by mode (not property+mode)
 * and removes the in-table property-type filtering since the parent now
 * scopes data to the active property tab.
 *
 * Nothing imports this file. Keep it here until the single-view refactor
 * is signed off and merged, then it can be deleted.
 */
